  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="relative bg-white">
            ...
            {photos.length > 1 && (
              <>
                <button
                  ...
                  className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/80 backdrop-blur p-2 rounded-full shadow-lg"
                >
                  <ChevronLeft className="h-4 w-4" />
                </button>
                <button
                  onClick={() => handleImageNavigation('next')}
                  className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/80 backdrop-blur p-2 rounded-full shadow-lg"
                >
        ...
        {/* Back button */}
        <Link href="/rooms" className="absolute top-4 left-4 bg-white/90 backdrop-blur p-2 rounded-full shadow-lg">
          <ChevronLeft className="h-4 w-4" />
        </Link>
      </div>
