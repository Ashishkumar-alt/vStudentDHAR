  ...
  return (
    <div className="min-h-dvh bg-transparent">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-30 border-t border-slate-200 bg-white/90 backdrop-blur sm:hidden">
        <div className="mx-auto grid w-full max-w-5xl grid-cols-4 gap-1 px-2 py-2">
      ...
      <footer className="mx-auto w-full max-w-5xl px-4 py-10 text-center text-xs text-slate-500">
